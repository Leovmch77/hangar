...
CATALOGO: dict[str, str] = {
    ...
    "etapa_lendo_plugins": "Lendo os plugins já instalados no Codex",
    "etapa_detectando": "Procurando no Claude o que falta no Codex",
    "etapa_importando_plugins": "Codex importando {plugins}",
    ...
    "erro_falha_etapa": "Falha em \"{etapa}\" ({tipo}); configuração anterior preservada nas etapas não concluídas",
