...
export type TelaConfig = 'root' | 'geral' | 'aparencia' | 'notificacoes' | 'anexos' | 'avancado' | 'sobre' | 'diario' | 'maquinas' | 'contas' | 'orquestracao' | 'voz' | 'harnesses' | 'sincronizacao';

const TELAS: readonly TelaConfig[] = ['root', 'geral', 'aparencia', 'notificacoes', 'anexos', 'avancado', 'sobre', 'diario', 'maquinas', 'contas', 'orquestracao', 'voz', 'harnesses', 'sincronizacao'];
...
export const TELAS_DE_SERVIDOR: readonly TelaConfig[] = ['contas', 'notificacoes', 'anexos', 'avancado', 'orquestracao', 'voz', 'harnesses', 'sincronizacao'];
