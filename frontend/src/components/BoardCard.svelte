...
<style>
  ...
  .bcard {
    ...
    /* flex-shrink: 0 é OBRIGATÓRIO: no Board o item flex da .col-cards é o .board-card-wrap (o
       wrapper de arrasto), não o .bcard direto, mas o encolhimento zero tem que valer pro card
       também — no default (shrink: 1) o navegador espreme TODOS os cards pra caber na coluna, com
       ~13 sessões cada um cai pra ~54px, o header resiste e o .bc-body colapsa pra ~0: cards
       vazios, sem conversa nenhuma. A coluna já tem overflow-y: auto; é ela que deve rolar. */
    flex-shrink: 0;
