# Planner — the team, the bars, the contract and the launch

Read after the spec closes, before Task 1 (`planejamento.md`, "Team first"). The decomposition
and the exit gate stay in `planejamento.md`.
